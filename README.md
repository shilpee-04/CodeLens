...
**Frontend**: [CodeTrail Dashboard](https://code-lens-git-main-shilpee-04s-projects.vercel.app/)
**Backend API**: [CodeTrail API](codelens-production-3cb3.up.railway.app)
